...
class Snake:
    ...
    def grow(self):
        ...
        rect = pygame.Rect(
            coordinates[0], coordinates[1], SNAKE_PART_WIDTH, SNAKE_PART_HEIGHT
        )
        new_part = SnakePart(
            self.__body_img__ if does_have_tail else self.__tail_img__, rect
        )
